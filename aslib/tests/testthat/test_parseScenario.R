...
test_that("parseASScenario2", {
  ...
  expect_equal(length(testscenario2$desc$feature_steps[[nams[1]]]$provides), 6)
  expect_equal(length(testscenario2$desc$feature_steps[[nams[2]]]$provides), 14)
  expect_equal(testscenario2$desc$feature_steps[[nams[2]]]$requires, "Pre")
  expect_equal(length(testscenario2$desc$feature_steps[[nams[3]]]$provides), 20)
  expect_equal(testscenario2$desc$feature_steps[[nams[3]]]$requires, "Pre")
  expect_equal(length(testscenario2$desc$feature_steps[[nams[4]]]$provides), 10)
  expect_equal(testscenario2$desc$feature_steps[[nams[4]]]$requires, "Pre")
  expect_equal(length(testscenario2$desc$feature_steps[[nams[5]]]$provides), 5)
  expect_equal(testscenario2$desc$feature_steps[[nams[5]]]$requires, "Pre")
  ...
  expect_equal(length(testscenario2$desc$feature_steps[[nams[7]]]$provides), 18)
  ...
  expect_equal(length(testscenario2$desc$feature_steps[[nams[10]]]$provides), 2)
